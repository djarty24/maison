...
const Navbar = () => {
  ...
  return (
    <nav style={{fontFamily: "'Raleway', sans-serif"}}>
        ...
        {isOpen && (
            <ul className='md:hidden w-full text-xl flex flex-col items-end gap-5 p-8 bg-white-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-30 border border-gray-100 absolute'>
